      ...
      <div className="container mt-5 pt-5">
        <div className="row" style={{height: '100%'}}>
          <div className="col-md-6 my-5 text-lg-left text-center align-start">
            <h1 className="display-3 text-light">Strive</h1>
            <h4 className="display-5 text-light">Your new favourite gym companion.</h4>
            <p className="lead text-light">Join a growing community of gym goers who improve their workouts using Strive.</p>
